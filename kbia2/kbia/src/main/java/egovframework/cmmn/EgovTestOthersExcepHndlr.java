 ...
 */
public class EgovTestOthersExcepHndlr implements ExceptionHandler {

	private static final Logger LOGGER = LoggerFactory.getLogger(EgovTestOthersExcepHndlr.class);
