 ...
 */
package egovframework.user.info.svc;
...
public interface InfoService {
	...
	Map<String, Object> selectBatteryContent(Map<String, Object> params) throws Exception;

	int batteryListCnt(Map<String, Object> params) throws Exception;
