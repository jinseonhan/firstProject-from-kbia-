...
<title>연혁 &lt; 연혁 &lt; 협회/조합 소개 &lt; 한국전지산업협회</title>
	...
	<!--// header -->
	<script src="/resouces/js/user/intro/introHistory2.js"></script>
	...
	<div id="container">
		...
		<div class="contents">
			...
			<div class="tabWrap">
				<ul>
					<li id="area1"><a href="/openIntroHistroy.do">협회 연혁</a></li>
					<li class="curr" id="area2"><a href="/openIntroHistory.do">조합 연혁</a></li>
				</ul>
				<!-- imgWrap -->
				<div class="imgWrap">
