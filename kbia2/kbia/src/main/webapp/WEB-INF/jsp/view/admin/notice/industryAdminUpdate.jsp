...
<!--// header -->
<script src="/resouces/js/admin/notice/industryAdminUpdate.js"></script>
<input type="hidden" id="path" value="industryAdminUpdate" /> <!-- 파일명 -->
<input type="hidden" id="mainPath" value="industry" /> <!-- 첫번째 path -->
<input type="hidden" id="mainPath2" value="industryMap" /> <!-- 두번째 path -->
...
<div id="container">
	...
	<jsp:include page="../lnb.jsp" flush="false"></jsp:include>
		...
		<input type="hidden" id="lnbset2" value="industry"> <!-- 해당 jsp명 -->
		<!-- contents -->
		<div class="contents">
			<h2>산업뉴스</h2>
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td><input type="text" title="제목 입력" id="industryTitle" class="w412"></td>
						</tr>
						<tr>
							<th scope="row">내용</th>
							<td style="padding: 6px 12px;">
								<textarea title="내용 입력" id="industryContent" placeholder="에디터영역" style="width: 100%;">
								</textarea>
							</td>
						</tr>
						<tr id="file">
						...
						<tr>
							...
							<td>
								<span class="date">
									<input type="text" id="industryDate" title="등록일선택">
								</span>
								<div class="selectbox w100">
									<span id="industryHourSpan">선택</span>
									<select title="시 선택" id="industryHour">
								...
								<div class="selectbox w100">
									<span id="industryMinuteSpan">선택</span>
									<select title="분 선택" id="industryMinute">
