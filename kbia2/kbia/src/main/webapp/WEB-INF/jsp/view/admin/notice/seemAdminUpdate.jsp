...
<!--// header -->
<script src="/resouces/js/admin/notice/seemAdminUpdate.js"></script>
<input type="hidden" id="path" value="seemAdminUpdate" /> <!-- 파일명 -->
<input type="hidden" id="mainPath" value="seem" /> <!-- 첫번째 path -->
<input type="hidden" id="mainPath2" value="seemMap" /> <!-- 두번째 path -->
...
<div id="container">
	...
	<!--// lnb -->
		...
		<div class="contents">
			...
			<div class="rowTable">
				<table>
					<caption>제목, 내용, 행사기간, 언어, 사용여부, 등록정보 항목으로 구성된 수정 테이블입니다.</caption>
					<colgroup>
					...
					<tbody>
						<tr>
							...
							<td><input type="text" title="제목 입력" id="seemTitle" class="w412"></td>
						</tr>
						<tr>
							<th scope="row">내용</th>
							<td style="padding: 6px 12px;">
								<textarea title="내용 입력" id="seemContent" placeholder="에디터영역" style="width: 100%;">
								</textarea>
							</td>
						</tr>
						<tr id="file">
						...
						<tr>
							...
							<td>
								<span class="date">
									<input type="text" id="seemDate" title="등록일선택">
								</span>
								<div class="selectbox w100">
									<span id="seemHourSpan">선택</span>
									<select title="시 선택" id="seemHour">
								...
								<div class="selectbox w100">
									<span id="seemMinuteSpan">선택</span>
									<select title="분 선택" id="seemMinute">
