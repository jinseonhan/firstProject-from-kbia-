...
<input type="hidden" id="lnbset2" value="PopList"> <!-- 해당 jsp명 -->
						...
						<tr>
							...
							<td>
								<div class="checkboxWrap">
									<span class="checkbox">
										<input type="radio" id="chk0102" name="chk01" value = "TEXT" checked>
										<label for="chk0102">텍스트</label>
									</span>
									<span class="checkbox">
										<input type="radio" id="chk0101" name="chk01" value = "IMG" >
