...
<!--// header -->
<script src="/resouces/js/admin/info/referenceAdminUpdate.js"></script>
<input type="hidden" id="path" value="referenceAdminUpdate" /> <!-- 파일명 -->
<input type="hidden" id="mainPath" value="reference" /> <!-- 첫번째 path -->
<input type="hidden" id="mainPath2" value="referenceMap" /> <!-- 두번째 path -->
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td><input type="text" title="제목 입력" class="w412" id="referenceTitle"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								...
								<div class="selectbox w100">
									<span id="referenceHourSpan">선택</span>
								...
								<div class="selectbox w100">
									<span id="referenceMinuteSpan">선택</span>
