...
<!-- E : mobile -->
<title>기술동향 &lt; 정보마당 &lt; 한국전지산업협회</title>
...
<div id="wrap">
				...
				<ul>
					...
					<li><a href="">산업/기술동향</a>
						<ul>
                            ...
                            <li class="curr"><a href="">기술동향</a></li>
						</ul>
					</li>
				</ul>
			</div>
	...
	<div id="container">
		...
		<div class="contents">
			...
			<div class="listTable">
				<table>
					<caption>번호, 제목, 작성자, 첨부파일, 등록일, 조회수 항목으로 구성된 기술동향 목록 표입니다.</caption>
					<colgroup>
					...
					<tbody>
						<tr>
							...
							<td>관리자</td>
							<td><a href="" class="btnDownload">첨부파일 다운로드</a><a href="" class="btnDownload">첨부파일 다운로드</a><a href="" class="btnDownload">첨부파일 다운로드</a></td>
							<td>2020-08-06</td>
							<td>120</td>
						</tr>
						<tr>
