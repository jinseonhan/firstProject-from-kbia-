		...
		<div id="gnb">
			<div class="inner">
				...
				<ul>
					...
					<li class="curr"><a href="">회원사 안내</a>
						<ul>
							<li><a href="">회원사 가입안내</a></li>
							<li class="curr"><a href="">회원사 안내</a></li>
						</ul>
					</li>
					<li><a href="">사업안내</a></li>
					<li><a href="">알림마당</a>
	...
	<div id="container">
		...
		<div class="contents">
			...
			<div class="tabWrap">
				...
				<div class="listTable">
					<table>
						<caption>로고, 회원사명, 대표이사, 업종, 홈페이지 항목으로 구성된 회원사 안내 표입니다.</caption>
						<colgroup>
						...
						<tbody>
							<tr>
								<td><p class="logo"><img src="../images/@logo01.png" alt="enchem"></p></td>
								<td>엔켐</td>
								<td>오정강</td>
								<td>전해액</td>
								<td><a href="" class="btnHome">홈페이지로 이동</a></td>
							</tr>
							<tr>
								<td><p class="logo"><img src="../images/@logo02.png" alt="LG화학"></p></td>
								<td>LG화학</td>
								<td>김종현</td>
								<td>전지</td>
								<td><a href="" class="btnHome">홈페이지로 이동</a></td>
