...
<!--// header -->
<script src="/resouces/js/admin/info/briefAdminList.js?20200115_8"></script>
	<!-- container -->
	<div id="container">
		<!-- lnb -->
		...
		<div class="contents">
			...
			<div class="searchArea">
				<div class="inBox">
					<table>
						<caption>등록일, 제목, 사용여부, 언어 항목으로 구성된 주간브리프 검색 표 입니다.</caption>
						<colgroup>
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="dateWrap">
										<span class="date"><input type="text" title="시작날짜선택" value="<%=beforeMonth %>"  id="startBriefDate"></span>
										<em>~</em>
										<span class="date" ><input type="text" title="종료날짜선택" value="<%=today.format(nowTime) %>" id="endBriefDate"></span>
									</div>
								</td>
							</tr>
							<tr>
								<th scope="row">제목</th>
								<td><input type="text" id="infoTitle" title="제목 입력" class="w430" placeholder="제목 입력"></td>
							</tr>
							<tr>
