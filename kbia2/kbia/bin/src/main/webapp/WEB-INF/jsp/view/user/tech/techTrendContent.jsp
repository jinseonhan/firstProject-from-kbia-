...
<!--// header -->
<script src="/resouces/js/user/tech/techTrendContent.js"></script>

<input type="hidden" id="path" value="techTrendList" /> <!-- 파일명 -->
...
<div id="container">
	...
	<div class="contents">
		...
		<!-- btnCenter -->
		<div class="btnCenter">
			<a href="/openTechTrend.do" class="btn btnGray">목록</a>
		</div>
		<!--// btnCenter -->
	</div>
	<!--// contents -->
