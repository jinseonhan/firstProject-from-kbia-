...
<div id="wrap">
	...
	<div id="container">
		...
		<div class="contents">
			...
			<div class="tabWrap">
				<ul>
					<li><a href="">협회 인재채용</a></li>
					<li class="curr"><a href="">회원사 인재채용</a></li>
				</ul>
				<!-- listTable -->
				<div class="listTable">
					<table>
						<caption>번호, 구분, 제목, 첨부파일, 지원기간 항목으로 구성된 회원사 인재채용 목록 표입니다.</caption>
						<colgroup>
						...
						<tbody>
							<tr>
								<td>1</td>
								<td><span class="label v3">회원사</span></td>
