...
<script src="/resouces/js/admin/info/trendAdminUpdate.js"></script>
<input type="hidden" id="path" value="trendAdminUpdate" /> <!-- 파일명 -->
<input type="hidden" id="mainPath" value="trend" /> <!-- 첫번째 path -->
<input type="hidden" id="mainPath2" value="trendMap" /> <!-- 두번째 path -->
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td><input type="text" title="제목 입력" class="w412" id="trendTitle" ></td>
						</tr>
						<tr>
							<th scope="row">내용</th>
							<td style="padding: 6px 12px;">
								<textarea title="내용 입력" id="trendContent" placeholder="에디터영역" style="width: 100%;">
								</textarea>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<span class="date">
									<input type="text" title="등록일선택" id="trendDate">
								</span>
								<div class="selectbox w100">
									<span id="trendHourSpan">선택</span>
									<select title="시 선택" id ="trendHour">
								...
								<div class="selectbox w100">
									<span id="trendMinuteSpan">선택</span>
									<select title="분 선택" id ="trendMinute">
						...
						<tr>
							...
							<td>
								<div class="checkboxWrap">
									<span class="checkbox">
										<input type="radio" id="chk0301" name="chk03" value="T" checked>
										<label for="chk0301">기술동향</label>
									</span>
									<span class="checkbox">
										<input type="radio" id="chk0302" name="chk03" value="A">
										<label for="chk0302">유관산업동향</label>
									</span>
								</div>
							</td>
						</tr>
