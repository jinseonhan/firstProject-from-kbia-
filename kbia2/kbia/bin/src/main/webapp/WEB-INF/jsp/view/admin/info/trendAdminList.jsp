					...
					<table>
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="dateWrap">
										<span class="date"><input type="text" title="시작날짜선택" value="<%=beforeMonth %>" id="startTrendDate"></span>
										<em>~</em>
										<span class="date"><input type="text" title="종료날짜선택" value="<%=today.format(nowTime) %>" id="endTrendDate"></span>
									</div>
								</td>
							</tr>
							<tr>
