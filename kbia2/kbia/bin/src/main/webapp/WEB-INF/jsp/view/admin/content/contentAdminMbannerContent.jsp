...
<script src="/resouces/js/admin/content/contentAdminMbannerContent.js"></script>
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td>
								<textarea  title="배너명 입력" id="text"></textarea>
							</td>
						</tr>
						...
						<tr id="mobile">
							...
							<td>
								<div class="file">
									<input type="text"  id= "fileMN" title="첨부파일 명">
									<input type="file"  id="upMfile" name="upMfile" title="파일 첨부">
								</div>
								<div id="fileMnameList">
							...
							<td>
								<span class="checkbox">
									...
									<div class="selectbox w100">
										...
										<select title="시 선택" id="mBannerEndSHour">
											<option value="00">00</option>
											<option value="01">01</option>
											<option value="02">02</option>
											<option value="03">03</option>
