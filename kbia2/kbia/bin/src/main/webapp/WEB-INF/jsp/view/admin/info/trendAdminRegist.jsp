...
<!--// header -->
<script src="/resouces/js/admin/info/trendAdminRegist.js"></script>
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td><input type="text" title="제목 입력" id="trendTitle" class="w412"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<span class="date">
									<input type="text" id="trendDate" title="등록일선택" >
								</span>
