...
<div id="wrap">
	...
	<div id="container">
		...
		<div class="contents">
			...
			<div class="colTable">
				<table>
					<caption>오늘 방문자 수, 이번달 방문자 수, 총방문자수 항목으로 구성된 월별통계 조회 리스트 테이블입니다.</caption>
					<colgroup>
			...
			<div class="tableTop mT20">
				<p class="total">검색기간: <strong>2020년도</strong></p>
			</div>
			<!--// tableTop -->
			<!-- colTable -->
			<div class="colTable">
				<table>
					<caption>날짜, 그래프, 접속통계 항목으로 구성된 월별통계 조회 리스트 테이블입니다.</caption>
					<colgroup>
						<col style="width:auto">
