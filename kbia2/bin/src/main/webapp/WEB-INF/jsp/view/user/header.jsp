...
<body>
<input type="hidden" id="author" value="${loginInfo.author}" />
				...
				<ul>
					...
					<li><a href="/openMemberGuide.do">회원사 안내</a>
						<ul>
							...
							<li><a class="headerA" href="/openMemberInfo.do" onclick="alert('서비스 준비중입니다.'); return false;">회원사 안내</a></li>
						</ul>
					</li>
					<!-- <li><a href="">사업안내</a></li> -->
					<li><a href="/openNotice.do">알림마당</a>
						<ul>
							...
							<li><a class="headerA" href="/openIndustry.do" onclick="alert('서비스 준비중입니다.'); return false;">산업뉴스</a></li>
							<li><a class="headerA" href="/openEvent.do" onclick="alert('서비스 준비중입니다.'); return false;">행사정보</a></li>
							<li><a class="headerA" href="/openMemberNewsList.do">산업계(회원사) 동정</a></li>
						</ul>
					</li>
					<li><a href="/openBrief.do" onclick="alert('서비스 준비중입니다.'); return false;">정보마당</a>
						<ul>
							<li><a class="headerA" href="/openBrief.do" onclick="alert('서비스 준비중입니다.'); return false;">주간브리프</a></li>
							<li><a class="headerA" href="/openBattery.do" onclick="alert('서비스 준비중입니다.'); return false;">The Battery</a></li>
							<li><a class="headerA" href="/openReference.do" onclick="alert('서비스 준비중입니다.'); return false;">기술자료실</a></li>
							<li><a class="headerA" href="/openGhireList.do" onclick="alert('서비스 준비중입니다.'); return false;">채용공고</a></li>
						</ul>
					</li>
					<li><a href="/openTechKnow.do">산업/기술동향</a>
						<ul>
							...
							<li><a class="headerA" href="/openRelatedTrend.do" onclick="alert('서비스 준비중입니다.'); return false;">유관산업 동향</a></li>
                            <li><a class="headerA" href="/openTechTrend.do" onclick="alert('서비스 준비중입니다.'); return false;">기술동향</a></li>
						</ul>
					</li>
				</ul>
			</div>
