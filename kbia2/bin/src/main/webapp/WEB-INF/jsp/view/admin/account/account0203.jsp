						...
						<tr>
							...
							<td>
								...
								<div class="colTable checkTable">
									<table>
										<caption>계정, 컨텐츠, 알림마당, 정보마당, 회원사 항목으로 구성된 권한 선택 테이블입니다.</caption>
										<colgroup>
											<col style="width:auto">
											<col style="width:auto">
											<col style="width:auto">
										...
										<tbody>
											<tr>
												<td>
													<span class="checkbox">
														<input type="checkbox" id="chk0102" checked>
												...
												<td class="bgGray">
													<span class="checkbox">
														<input type="checkbox" id="chk0502">
														<label for="chk0502">산업동향</label>
													</span>
												</td>
											</tr>
											<tr>
												<td>
													<span class="checkbox">
														<input type="checkbox" id="chk0103" checked>
												...
												<td class="bgGray">
													<span class="checkbox">
														<input type="checkbox" id="chk0503">
														<label for="chk0503">통계</label>
													</span>
												</td>
											</tr>
											<tr>
