...
<title>산업뉴스 &lt; 한국전지산업협회</title>


<!-- header -->
<jsp:include page="/WEB-INF/jsp/view/user/header.jsp" flush="false"></jsp:include>
<!--// header -->
<script src="/resouces/js/user/notice/industryContent.js"></script>

<input type="hidden" id="path" value="industryContent" /> <!-- 파일명 -->
...
<input type="hidden" id="viewCnt" value="${param.viewCnt}" />
...
<div id="container">
	...
	<div class="contents">
		...
		<!-- btnCenter -->
		<div class="btnCenter">
			<a href="/openIndustry.do" class="btn btnGray">목록</a>
		</div>
		<!--// btnCenter -->
	</div>
	<!--// contents -->
