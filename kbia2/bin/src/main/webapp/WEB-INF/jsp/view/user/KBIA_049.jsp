...
<!-- E : mobile -->
<title>산업뉴스 &lt; 알림마당 &lt; 한국전지산업협회</title>
...
<div id="wrap">
			...
			<div class="inner">
				...
				<ul>
					...
					<li class="curr"><a href="">알림마당</a>
						<ul>
							<li><a href="">공지사항</a></li>
							<li class="curr"><a href="">산업뉴스</a></li>
							<li><a href="">행사정보</a></li>
	...
	<div id="container">
			...
			<div class="inner">
				...
				<div>
					...
					<ul>
						...
						<li><a href="">산업뉴스</a></li>
						<li><a href="">행사정보</a></li>
						<li class="curr"><a href="">회원사 동정</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="contents">
			...
			<div class="listTable">
				<table>
					<caption>번호, 제목, 출처, 등록일, 조회수 항목으로 구성된 회원사동정 목록 표입니다.</caption>
					<colgroup>
					...
					<tbody>
						...
						<tr>
							<td>7</td>
							<td class="txtL"><a href="">제목영역입니다.제목영역입니다.제목영역입니다.제목영역입니다.</a></td>
							<td></td>
							<td>2020-08-06</td>
							<td>51</td>
						</tr>
