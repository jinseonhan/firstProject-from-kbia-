...
<title>회원사 동정 &lt; 한국전지산업협회</title>


<!-- header -->
<jsp:include page="/WEB-INF/jsp/view/user/header.jsp" flush="false"></jsp:include>
<!--// header -->
<script src="/resouces/js/user/notice/memNewsContent.js"></script>

<input type="hidden" id="path" value="memNewsContent" /> <!-- 파일명 -->
...
<div id="container">
	...
	<div class="contents">
		...
		<!-- btnCenter -->
		<div class="btnCenter">
			<a href="/openMemberNewsList.do" class="btn btnGray">목록</a>
		</div>
		<!--// btnCenter -->
	</div>
	<!--// contents -->
