...
<div id="wrap">
	...
	<div id="container">
			...
			<div class="inner">
				...
				<div>
					...
					<ul>
						...
						<li><a href="">사업안내</a></li>
						<li><a href="">알림마당</a></li>
						<li class="curr"><a href="">정보마당</a></li>
		...
		<div class="contents">
			...
			<div class="tabWrap">
				<ul>
					<li class="curr"><a href="">협회 인재채용</a></li>
					<li><a href="">회원사 인재채용</a></li>
				</ul>
				<!-- listTable -->
				<div class="listTable">
					<table>
						<caption>번호, 구분, 제목, 첨부파일, 지원기간 항목으로 구성된 협회 인재채용 목록 표입니다.</caption>
						<colgroup>
						...
						<tbody>
							<tr>
								<td>1</td>
								<td><span class="label v1">채용</span></td>
								<td class="txtL"><a href="">제목영역입니다.제목영역입니다.제목영역입니다.제목영역입니다.제목영역입니다.제목영역입니다.</a></td>
								<td><a href="" class="btnDownload">첨부파일 다운로드</a></td>
								<td>2020-12-28 ~ 2020-12-28</td>
							</tr>
							<tr>
								<td>1</td>
								<td><span class="label v2">관리자</span></td>
								<td class="txtL"><a href="">제목영역입니다.</a></td>
								<td><a href="" class="btnDownload">첨부파일 다운로드</a></td>
								<td>2020-12-28 ~ 2020-12-28</td>
							</tr>
							<tr>
				...
				<div class="searchArea">
					...
					<button type="button" class="btn btnLGray">검색</button>
				</div>
				<!--// searchArea -->
			</div>
			<!--// tabWrap -->
