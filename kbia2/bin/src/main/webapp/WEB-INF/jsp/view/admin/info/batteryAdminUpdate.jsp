...
<!--// header -->
<script src="/resouces/js/admin/info/batteryAdminUpdate.js"></script>
<input type="hidden" id="path" value="batteryAdminUpdate" /> <!-- 파일명 -->
<input type="hidden" id="mainPath" value="battery" /> <!-- 첫번째 path -->
<input type="hidden" id="mainPath2" value="batteryMap" /><!-- 두번째 path -->
...
<!-- contents -->
	<div class="contents">
		...
		<!-- rowTable -->
			<div class="rowTable">
				<table>
					<caption>제목, 목차, 썸네일, 첨부파일, 등록일, 언어, 사용여부, 등록정보 항목으로 구성된 수정 테이블입니다.</caption>
					<colgroup>
					...
					<tbody>
						...
						<tr>
							...
							<td style="padding: 6px 12px;">
								<textarea title="목차 입력" id="batteryContent" placeholder="에디터영역" style="width: 100%;"></textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<span class="date">
								<input type="text" title="등록일선택" id="batteryDate">
								</span>
								<div class="selectbox w100">
									<span id="batteryHourSpan">선택</span>
								...
								<div class="selectbox w100">
									<span id="batteryMinuteSpan">선택</span>
