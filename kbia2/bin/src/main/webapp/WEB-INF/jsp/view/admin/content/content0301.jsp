				...
				<div class="tabArea tabFunc">
					...
					<div class="tabContArea">
						...
						<div>
							...
							<div class="colTable">
								<table>
									<caption>순번, 언어, 년/월, 제목, 사용여부, 등록일 항목으로 구성된 협회 연혁 조회 리스트 테이블입니다.</caption>
									<colgroup>
						...
						<div>
							...
							<div class="colTable">
								<table>
									<caption>순번, 언어, 년/월, 제목, 사용여부, 등록일 항목으로 구성된 조합 연혁 조회 리스트 테이블입니다.</caption>
									<colgroup>
										<col style="width:80px">
										<col style="width:auto">
										<col style="width:auto">
