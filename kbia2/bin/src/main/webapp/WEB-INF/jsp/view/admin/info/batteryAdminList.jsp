...
<!--// header -->
<script src="/resouces/js/admin/info/batteryAdminList.js"></script>
	...
	<div id="container">
		...
		<div class="contents">
			...
			<div class="searchArea">
				<div class="inBox">
					<table>
						<caption>등록일, 제목, 사용여부, 언어 항목으로 구성된 The Battery 검색 표 입니다.</caption>
						<colgroup>
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="dateWrap">
										<span class="date"><input type="text" title="시작날짜선택" value="<%=beforeMonth %>" id="startBatteryDate"></span>
										<em>~</em>
										<span class="date"><input type="text" title="종료날짜선택"  value="<%=today.format(nowTime) %>" id="endBatteryDate"></span>
									</div>
								</td>
							</tr>
							<tr>
								<th scope="row">제목</th>
								<td><input type="text" id="batteryTitle" title="제목 입력" class="w430"></td>
							</tr>
							<tr>
