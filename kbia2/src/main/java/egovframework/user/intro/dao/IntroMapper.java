 ...
 */
package egovframework.user.intro.dao;
...
public interface IntroMapper {
	 ...
	 * @exception Exception
	 */
	List<Map<String, Object>> selectOrganTop(Map<String, Object> param)throws Exception;
	 ...
	 * @exception Exception
	 */
	List<Map<String, Object>> selectOrganBottom(Map<String, Object> param);
