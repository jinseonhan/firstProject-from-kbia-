 ...
 */
package egovframework.user.notice.vo;
...
public class NoticeVO {
	...
	public String getMemberNewsDate() {
		return memberNewsDate;
	}
	public void setMemberNewsDate(String memberNewsDate) {
		this.memberNewsDate = memberNewsDate;
	}
