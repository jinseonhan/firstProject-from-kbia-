...
//        }
	 ...
	 * 회원사 노출 순서 중복 체크
	*/
	@RequestMapping(value = "/admin/chkExpoNo.do")
	public void chkOutSeq(HttpServletRequest request, HttpServletResponse response, @RequestParam Map<String, Object> params) throws Exception {
		LOGGER.info("# Call chkOutSeq.do");
		...
		try {
			out = response.getWriter();
			result = memberAdminService.chkExpoNo(params);
		} catch(Exception e ) {
			e.printStackTrace();
		}
