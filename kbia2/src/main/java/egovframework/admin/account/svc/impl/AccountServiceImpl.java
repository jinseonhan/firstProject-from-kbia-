...
import egovframework.admin.account.dao.AccountMapper;
...
public class AccountServiceImpl extends EgovAbstractServiceImpl implements AccountService {
	...
	public int selectUserCnt(Map<String, Object> param) throws Exception {
		...
		int result = accountMapper.selectUserCnt(param);
	...
	public List<Map<String,Object>> selectUserList(Map<String, Object> param) throws Exception {
		...
		List<Map<String,Object>> result = accountMapper.selectUserList(param);
	...
	public int secession(Map<String, Object> param) throws Exception {
		...
		int result = accountMapper.secession(param);
	 ...
	 */
	@Override
	public int useYnUpdate(Map<String, Object> param) throws Exception {
		LOGGER.info("@@ param : " + param);
		
		int result = accountMapper.useYnUpdate(param);
