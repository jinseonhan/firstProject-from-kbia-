...
public interface AdminNoticeService {
	...
	int NoticeRegist(Map<String, Object> param) throws Exception;

	List<Map<String, Object>> selectNotice(Map<String, Object> params) throws Exception;

	int noticeUpdate(Map<String, Object> param) throws Exception;

	int noticeDelete(Map<String, Object> param) throws Exception;;
