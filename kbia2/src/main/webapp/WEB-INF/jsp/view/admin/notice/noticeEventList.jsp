...
<script src="/resouces/js/admin/notice/noticeEventList.js"></script>
							...
							<tr>
								...
								<td>
									<div class="checkboxWrap">
										...
										<span class="checkbox">
											<input type="radio" id="chk0202" name="chk02" value="Y">
											<label for="chk0202">국문</label>
										</span>
										<span class="checkbox">
											<input type="radio" id="chk0203" name="chk02" value="N">
