					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<span>-</span>
								<input type="text" title="대표전화번호 입력" placeholder="숫자 입력" id="comRepreNum2" maxlength='13' >
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<span>-</span>
								<input type="text" title="팩스번호 입력" placeholder="숫자 입력" id="fax2" maxlength='13' >
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<div class="checkboxWrap">
									<span class="checkbox">
										<input type="checkbox" id="isExpo" name="isExpo" value="N">
										<label for="isExpo">메인 노출</label>
									</span>
									<span class="inputbox">
										<input type="text" id="expoNo" name="expoNo" maxlength="3" numberonly placeholder="노출순서" disabled>
									</span>
								</div>
							</td>
						</tr>
