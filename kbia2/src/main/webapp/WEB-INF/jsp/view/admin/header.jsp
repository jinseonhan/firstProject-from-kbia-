...
<!--<script type="text/javascript" src="/resouces/static/js/service/HuskyEZCreator.js"></script> -->
 <script type="text/javascript" src="/resouces/smarteditor2/js/HuskyEZCreator.js"></script>  
<body>
<input type="hidden" id="sessionAuthor" value="${adminInfo.author}"/>
<input type="hidden" id="sessionUserId" value="${adminInfo.userId}" />
<!-- wrap -->
<div id="wrap" class="jui">
	<!-- header -->
	<div id="header">
		<div class="inner">
			<h1><a href="/admin/openAccount.do">한국전지산업협회</a></h1>
			<div class="util">
