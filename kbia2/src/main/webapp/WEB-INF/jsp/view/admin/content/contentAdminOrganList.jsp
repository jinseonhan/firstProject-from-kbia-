...
<script src="/resouces/js/admin/content/contentOrganList.js"></script>
				...
				<div class="inBox">
					<table>
						...
						<tbody>
							...
							<tr>
								<th scope="row">이름</th>
								<td><input type="text" id="name" title="제목 입력" class="w430"></td>
							</tr>
							<tr>
								...
								<td>
									<div class="checkboxWrap">
										<span class="checkbox">
											<input type="radio" id="chk0101" name="useYn" value = "all" checked>
							...
							<tr>
								...
								<td>
									<div class="checkboxWrap">
										<span class="checkbox">
											<input type="radio" id="chk0201" name="lang" value="all" checked>
											<label for="chk0201">전체</label>
										</span>
										<span class="checkbox">
											<input type="radio" id="chk0202" name="lang" value="KOR">
											<label for="chk0202">국문</label>
										</span>
										<span class="checkbox">
											<input type="radio" id="chk0203" name="lang" value="ENG">
