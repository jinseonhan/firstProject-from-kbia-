...
<!--// header -->
<script src="/resouces/js/admin/info/hireAdminUpdate.js"></script>
<input type="hidden" id="path" value="hireAdminUpdate" /> <!-- 파일명 -->
<input type="hidden" id="mainPath" value="hire" /> <!-- 첫번째 path -->
<input type="hidden" id="mainPath2" value="hireMap" /> <!-- 두번째 path -->
<input type="hidden" id="boardNo" value="${param.boardNo}" />
<input type="hidden" id="boardType" value="${param.boardType}" />
<input type="hidden" id="stFileNm" value="${param.stFileNm }" /> <!-- 파일명 -->
<input type="hidden" id="filePath" value="${param.filePath}" /> <!-- 파일경로 -->
<input type="hidden" id="ognFileNm" value="${param.ognFileNm}" /> <!-- 오리지널 -->
<!-- 파일업데아트 플래그 -->
...
<div id="container">
	...
	<!-- contents -->
		<div class="contents">
			...
			<div class="rowTable">
				<table>
					<caption>분류, 구분, 제목, 내용, 첨부파일, 채용 기간, 언어, 사용여부, 등록정보 항목으로 구성된 수정 테이블입니다.</caption>
					<colgroup>
					...
					<tbody>
						...
						<tr>
							<th scope="row">구분</th>
							<td><input type="text" title="구분 입력" class="w412" id="division"></td>
						</tr>
						<tr>
							<th scope="row">제목 <span class="cRed">*</span></th>
							<td><input type="text" title="제목 입력" class="w412" id="hireTitle"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<span class="date">
									<input type="text" title="등록일선택" id="hireStrDate">
								</span>
								<div class="selectbox w100">
									<span id="startHourSpan" >선택</span>
									<select title="시 선택" id="hireStrHour">
								...
								<div class="selectbox w100">
									<span id="startMinuteSpan">선택</span>
									<select title="분 선택" id="hireStrMinute">
								...
								<span class="date">
									<input type="text" title="등록일선택" id="hireEndDate">
								</span>
								<div class="selectbox w100">
									<span id="endHourSpan">선택</span>
						...
						<tr>
							...
							<td>
								<div class="checkboxWrap">
									<span class="checkbox">
										<input type="radio" id="chk0201" value="KOR" name="chk02" checked>
										<label for="chk0201">국문</label>
									</span>
									<span class="checkbox">
										<input type="radio" id="chk0202" value="ENG" name="chk02">
						...
						<tr>
							...
							<td>
								<div class="checkboxWrap">
									<span class="checkbox">
										<input type="radio" id="chk0301" value="Y" name="chk03" checked>
										<label for="chk0301">사용</label>
									</span>
									<span class="checkbox">
										<input type="radio" id="chk0302" value="N" name="chk03">
