...
<script src="/resouces/js/admin/content/contentAdminLitList.js"></script>
					...
					<table>
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="dateWrap">
										<span class="date"><input type="text" id="sDate" title="시작날짜선택"></span>
										<em>~</em>
										<span class="date"><input type="text" id="eDate" title="종료날짜선택"></span>
									</div>
								</td>
							</tr>
							<tr>
