							...
							<div class="inBox">
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<a id="notice0_href">
											<span id="notice0_div" style="display:none"></span>
											<strong id="notice0_title"></strong>
											<p id="notice0_title"></p>
										</a>
									</div>
									<div class="swiper-slide">
										<a id="notice1_href">
			...
			<div class="mainCont v4">
				...
				<div class="siteMap">
					...
					<li><a href="/openIntroComment.do">협회/조합 소개</a>
						<ul>
							<li><a class="mainA" href="/openIntroComment.do">인사말</a></li>
							<li><a class="mainA" href="/openIntroHistroy.do">연혁</a></li>
							<li><a class="mainA" href="/openOrganization.do">조직도 및 연락처</a></li>
							<li><a class="mainA" href="/openExecutives.do">임원현황</a></li>
							<li><a class="mainA" href="/openMainTask.do">주요업무</a></li>
							<li><a class="mainA" href="/openCI.do">CI</a></li>
							<li><a class="mainA" href="/openComeRoot.do">오시는 길</a></li>
						</ul>
					</li>
					
					<li><a href="/openMemberGuide.do">회원사 안내</a>
						<ul>
							<li><a class="mainA" href="/openMemberGuide.do">회원사 가입안내</a></li>
							<li><a class="mainA" href="/openMemberInfo.do">회원사 안내</a></li>
						</ul>
					</li>
					...
					<li class="curr"><a href="">알림마당</a>
						<ul>
							...
							<li><a class="mainA" href="/openIndustry.do">산업뉴스</a></li>
							<li><a class="mainA" href="/openEvent.do" >행사정보</a></li>
							<li><a class="mainA" href="/openMemberNewsList.do">산업계(회원사) 동정</a></li>
						</ul>
					</li>
					<li><a href="/openBrief.do">정보마당</a>
						<ul>
							<li><a class="mainA" id="brief" href="/openBrief.do">주간브리프</a></li>
							<li><a class="mainA" id="battery" href="/openBattery.do">The Battery</a></li>
							<li><a class="mainA" id="tRoom" href="/openReference.do">기술자료실</a></li>
							<li><a class="mainA" href="/openGhireList.do">채용공고</a></li>
						</ul>
					</li>
					<li><a href="">산업/기술동향</a>
						<ul>
							<li><a class="mainA" href="/openTechKnow.do">전지의 이해</a></li>
							<li><a class="mainA" id="industryStat" href="/openIndustryStat.do">산업통계</a></li>
							<li><a class="mainA" id="aTrends" href="/openRelatedTrend.do">유관산업 동향</a></li>
                            <li><a class="mainA" id="tTrends" href="/openTechTrend.do">기술동향</a></li>
						</ul>
					</li>
				</ul>
					</div>
