		...
		, success : function(data) {
			...
			if(data.length > 0){
				for(var i=0; i<data.length; i++){
					var filePath = data[i].filePath.substring(data[i].filePath.length-7, data[i].filePath.length-1);
					if(filePath != 'upThum'){
